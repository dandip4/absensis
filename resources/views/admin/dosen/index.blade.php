                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="{{ route('dosen.create')}}" class="btn btn-primary btn-round ml-auto">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="{{ route('dosen.edit', $data->id) }}" class="btn btn-link btn-primary btn-lg" data-toggle="tooltip" title="Edit">
